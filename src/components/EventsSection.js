...
const EventsSection = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try { setEvents(await listContent('events')); }
  ...
  return (
    <section className="py-12">
      <div className="container mx-auto">
        ...
        {events.length === 0 ? <p className="text-center text-gray-500">No events available yet.</p> : <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
